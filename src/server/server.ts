...
import loadAllRouter from '#server/routes/index';
import { initApp } from '#server/routes/init';
import { localhostMover } from '#server/routes/localhostMover';
import swaggerDocs from '#server/server.swagger';
